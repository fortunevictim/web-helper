...
import ru.nsu.fit.pupynin.webhelper.JenaWork.complete_documents.document_type.core.IndividualTaskTRPS;
...
public record MasterIndividualTaskTRPS() implements IndividualTaskTRPS {
    ...
    static {
        ...
        DOC_FIELD_TO_SOLUTION.put("магДатаРукТРПС", simple("маг_дата_рук_трпс"));
